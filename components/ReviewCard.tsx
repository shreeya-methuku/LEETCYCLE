...
const ReviewCard: React.FC<ReviewCardProps> = ({ problem, onReview, onEdit }) => {
  ...
  return (
    <div className="w-full bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden hover:border-zinc-700 transition-colors group">
      ...
      <div className="p-5 flex justify-between items-start gap-4 cursor-pointer" onClick={() => setFlipped(!flipped)}>
      ...
      {flipped && (
        <div className="px-5 pb-5 animate-in slide-in-from-top-2 duration-200">
          ...
          {/* Notes Section */}
          {problem.notes && (
            <div className="mb-5 p-3 rounded-lg bg-black border border-zinc-800/50">
